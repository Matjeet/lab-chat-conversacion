# Arquetipo backend MVC — Spring Boot

Plantilla base para servicios backend en **Spring Boot 4 / Java 25** con arquitectura MVC por
capas. El paquete `sample` contiene un recurso CRUD completo (`Product`) que se usa como
plantilla: se copia, se renombra para la entidad real y se ajustan los campos.
...
| Persistencia | Spring Data JPA + Hibernate, H2 en memoria para dev |
...
| Recurso | URL |
|---------|-----|
| API ejemplo | http://localhost:8080/api/v1/products |
| Swagger UI | http://localhost:8080/swagger-ui.html |
| OpenAPI JSON | http://localhost:8080/v3/api-docs |
| Actuator health | http://localhost:8080/actuator/health |
| Consola H2 | http://localhost:8080/h2-console (JDBC `jdbc:h2:mem:appdb`, user `sa`) |
