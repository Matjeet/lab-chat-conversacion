...
/**
 * Configuracion del servidor gRPC embebido. {@code enabled=false} evita por completo el
 * arranque del servidor (los tests lo desactivan para no pelearse por el puerto).
 */
